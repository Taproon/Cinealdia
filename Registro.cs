...
namespace Cinealdia
{
    public partial class Registro : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla '_5tueH5qnuVDataSet1.provincias' Puede moverla o quitarla según sea necesario.
            this.provinciasTableAdapter1.Fill(this._5tueH5qnuVDataSet1.provincias);
        ...
        private void btn_registro_Click(object sender, EventArgs e)
        {
            ...
            if (vacio == true)
            {
                ...
                if (validarMail(mail) == true)
                {
                    ...
                    connect.Open();
                    String query = "INSERT INTO usuarios (nombreuser, correo, provincia, fechanac, contraseña) VALUES ('" + nombre + "','" + mail + "','" + provincia + "','" + fecha + "','" + password + "');";
