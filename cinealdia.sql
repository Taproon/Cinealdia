...
INSERT INTO `actores` (`nombre`, `apellidos`, `personaje`, `idpelicula`) VALUES
	('Jhon', 'Wick', 'Jhon Wick', 17),
	('Jhon', 'Wick', 'Jhon Wick', 17);
...
-- Volcando datos para la tabla cinealdia.bso: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla cinealdia.directores: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla cinealdia.guionistas: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla cinealdia.peliculas: ~0 rows (aproximadamente)
...
INSERT INTO `peliculas` (`titulo`, `estudio`, `año`, `puntuacion`, `duracion`, `estado`, `generos`, `publico`, `tipo`, `portada`, `comentario`, `idpelicula`, `idusuario`) VALUES
	('', 'Warner', 1988, 8, 150, 'En coleccion, ', 'Comedia, Ciencia-Ficción, ', 'PG-16', 'Pelicula', _binary 0x53797374656D2E57696E646F77732E466F726D732E50696374757265426F782C2053697A654D6F64653A2053747265746368496D616765, 0, 17, 'Taproon');
